...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO pharmacy (PharPhoneNo,PharName,LoAddress,email, password) VALUES (?,?,?,?,?)");
    $stmt->bind_param("issss",$Pharmacys_Phone_Number, $Pharmacys_Name,$Location,$Email,$hashedPassword);
