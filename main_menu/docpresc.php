...
$sql = "SELECT PresID, PresDate, TradeName, Dosage, SSN, Pfname, Plname FROM prescription WHERE DSSN=?";
...
if ($stmt->execute()) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "No prescription details available for the logged-in doctor.";
    }
} else {
